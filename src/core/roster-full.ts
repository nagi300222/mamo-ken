...
export const FULL_ROSTER = [
  {
    ...
    heightRatio: 1, widthRatio: 1, selectionDisplayScale: 1, accessoryJa: '赤ハチマキ',
  ...
  },
  {
    ...
    heightRatio: null, widthRatio: null, selectionDisplayScale: 1.04, accessoryJa: '青リストバンド',
  ...
  },
  {
    ...
    heightRatio: null, widthRatio: null, selectionDisplayScale: 1.08, accessoryJa: '黒帯',
  ...
  },
  {
    ...
    heightRatio: 1.05, widthRatio: 1.18, selectionDisplayScale: 1.05, accessoryJa: '深緑の厚い首巻き',
  ...
  },
  {
    ...
    heightRatio: 0.98, widthRatio: 1, selectionDisplayScale: 0.98, accessoryJa: '紫の細い房付き首紐',
  ...
  },
  {
    ...
    heightRatio: 1.07, widthRatio: 1.14, selectionDisplayScale: 1.07, accessoryJa: '黄土色の太い肩縄',
  ...
  },
  {
    ...
    heightRatio: 1, widthRatio: 0.95, selectionDisplayScale: 1, accessoryJa: '片手だけ白い手甲',
  ...
  },
  {
    ...
    heightRatio: 1.03, widthRatio: 1.1, selectionDisplayScale: 1.03, accessoryJa: '首から下げた木の実3個',
    artMasterPath: 'design/character_art/source_manifest.json#bullet', selectionAssetPath: 'assets/roster3d/bullet.webp', notes: ['胴が厚い箱型中量級', '長い尾'],
  },
  {
    ...
    heightRatio: 1, widthRatio: 1, selectionDisplayScale: 1, accessoryJa: '暗赤ハチマキ',
...
export function validateFullRoster(roster: readonly FullRosterCharacter[] = FULL_ROSTER): void {
  ...
  if (!dark || dark.heightRatio !== 1 || dark.widthRatio !== 1) throw new Error('dark_moguzo must preserve Moguzo body scale');
}
