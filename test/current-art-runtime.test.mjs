...
assert.ok(prototype.includes("const BUILD_ID='mamoken-ability-r2-special-core-2026-08-10'"));
assert.ok(dist.includes("const BUILD_ID='mamoken-ability-r2-special-core-2026-08-10'"));
